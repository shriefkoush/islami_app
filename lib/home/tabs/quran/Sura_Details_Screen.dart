    ...
    return Scaffold(
      appBar: AppBar(
        title: Padding(
          ...
          child: Center(child: Text(args.SuraEnglishName,
      ...
      body: Stack(alignment: Alignment.topCenter,
        ...
        Container(
          ...
          child: Image.asset("assets/images/details_bg.png",fit: BoxFit.fill,width:double.infinity,
              height:double.infinity ,),
        ),
          Column(children: [SizedBox(height: 17,),
